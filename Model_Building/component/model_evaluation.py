...
class ModelEvalutaion:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            # Finding location of transformation model 
            logging.info("Finding location of the transform model")
            transformer_path = self.model_resolver.latest_transform_path()
            model_path = self.model_resolver.latest_model_path()
            ...
            target_df = test_df['Item_Outlet_Sales']
            y_true =target_df
